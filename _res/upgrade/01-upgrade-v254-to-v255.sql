...
insert into account ( 
  ...
  type, leftindex, rightindex 
) 
select * 
from ( 
  select 
    objid, 'SRE-V254' as maingroupid, code, title, null as groupid, 
    'root' as type, null as leftindex, null as rightindex  
  from sreaccount 
  where parentid is null
  union all 
  select 
    a.objid, 'SRE-V254' as maingroupid, a.code, a.title, null as groupid, 
    'group' as type, null as leftindex, null as rightindex  
  ...
  select 
    a.objid, 'SRE-V254' as maingroupid, a.code, a.title, null as groupid, 
    'item' as type, null as leftindex, null as rightindex  
  from sreaccount a, sreaccount p  
  where a.parentid is not null 
    and a.parentid = p.objid 
    and a.type = 'detail' 
  ...
  select 
    a.objid, 'SRE-V254' as maingroupid, a.code, a.title, null as groupid, 
    'detail' as type, null as leftindex, null as rightindex  
  from sreaccount a, sreaccount p  
  where a.parentid is not null 
    and a.parentid = p.objid 
...
CREATE TABLE `ztmp_migration_afunit` (
  `objid` varchar(50) NOT NULL,
  `itemid` varchar(50) NOT NULL,
  `unit` varchar(10) NOT NULL,
  `qty` int(11) NULL,
...
; 
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('0016-STUB', '0016', 'STUB', '50', '0.00', '1', 'cashreceipt-form:0016', NULL);
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('907-STUB', '907', 'STUB', '50', '0.00', '1', 'cashreceipt-form:907', NULL);
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('51-STUB', '51', 'STUB', '50', '0.00', '1', 'cashreceipt:printout:51', 'cashreceiptdetail:printout:51');
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('52-STUB', '52', 'STUB', '50', '0.00', '1', 'cashreceipt-form:52', NULL);
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('53-STUB', '53', 'STUB', '50', '0.00', '1', 'cashreceipt-form:53', NULL);
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('54-STUB', '54', 'STUB', '50', '0.00', '1', 'cashreceipt-form:54', NULL);
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('56-STUB', '56', 'STUB', '50', '0.00', '1', 'cashreceipt-form:56', 'cashreceiptdetail:printout:56');
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('57-STUB', '57', 'STUB', '50', '0.00', '1', 'cashreceipt-form:57', NULL);
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('58-STUB', '58', 'STUB', '50', '0.00', '1', 'cashreceipt-form:58', NULL);
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('CT1-PAD', 'CT1', 'PAD', '2000', '0.00', '1', NULL, NULL);
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('CT10-PAD', 'CT10', 'PAD', '2000', '0.00', '1', NULL, NULL);
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('CT2-PAD', 'CT2', 'PAD', '2000', '0.00', '1', NULL, NULL);
INSERT INTO `ztmp_migration_afunit` (`objid`, `itemid`, `unit`, `qty`, `saleprice`, `interval`, `cashreceiptprintout`, `cashreceiptdetailprintout`) VALUES ('CT5-PAD', 'CT5', 'PAD', '2000', '0.00', '1', NULL, NULL);

insert into afunit (
  objid, itemid, unit, qty, saleprice, `interval`, cashreceiptprintout, cashreceiptdetailprintout
)
select 
  z.objid, z.itemid, z.unit, z.qty, z.saleprice, z.`interval`, z.cashreceiptprintout, z.cashreceiptdetailprintout
from ztmp_migration_afunit z 
  inner join af on af.objid = z.itemid 
where (select count(*) from afunit where itemid = z.itemid and unit = z.unit) = 0 
; 

drop table ztmp_migration_afunit;
...
update af_control set unit='STUB' where unit is null;
...
alter table collectiontype_account drop foreign key fk_collectiontype_account_account;
...
alter table creditmemoitem drop foreign key fk_creditmemoitem_itemaccount;
alter table creditmemoitem drop foreign key fk_creditmemoitem_parent;
